...
public class CardNavigationRootActivity extends NavigationRootActivity
    ...
    private void clearNativeCache() {
        ...
        Log.d("clear cache","get token before clear"+cardShareDataStore.getCookieManagerInstance().getSecToken());
        ...
        cardShareDataStore.getCookieManagerInstance().clearSecToken(); // Call
                                                                       // to
      Log.d("clear cache","get token after clear"+cardShareDataStore.getCookieManagerInstance().getSecToken());                                                                 // clear
                                                                       // the
                                                                       // sectoken
    }
