...
/**
 * This class is a modal alert with only a top view (no bottom buttons). This
 * view will only show a title and some content text (or some other variation).
 * 
 * @author jthornton
 * 
 */
public class SimpleModalAlert extends AlertDialog {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        final LinearLayout linearLayout = (LinearLayout) mainView
