 ...
 * 
 */
public class ModalDefaultTwoButtonBottomView extends RelativeLayout implements
        ModalBottomTwoButtonView {
    ...
    public ModalDefaultTwoButtonBottomView(final Context context,
        ...
        mainCallToActionButton = (Button) buttonView
                .findViewById(R.id.modal_ok_button);
        cancelButton = (Button) buttonView
                .findViewById(R.id.modal_alert_cancel);
        addView(buttonView);
    }
    ...
    public void setOkButtonText(final int resource) {
        mainCallToActionButton.setText(context.getResources().getString(
                resource));
    }
