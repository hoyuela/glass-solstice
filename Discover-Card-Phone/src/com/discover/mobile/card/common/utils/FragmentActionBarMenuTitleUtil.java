 ...
 * ©2013 Discover Bank
 * 
 * Common Utility class for setting Action Bar title & LHS Menu Item
 * 
 * @author CTS
 * 
 * @version 1.0
...
public class FragmentActionBarMenuTitleUtil {
    ...
    public FragmentActionBarMenuTitleUtil(CardNavigationRootActivity activity) {
        ...
        cordovaWebFrag = (activity).getCordovaWebFragInstance();
        mCardMenuLocation = CardMenuItemLocationIndex.getInstance(activity);
    }
