...
public class Utils {
    ...
    public static void hideScreensDetails(final ArrayList<String> hideScreens , final Context contextValue) {
        // TODO Auto-generated method stub
        hideScreensInApp = new ArrayList<String>() ;
        for(String itr : hideScreens){
            hideScreensInApp.add(itr.replaceAll("\\_", ""));
        }
            
        context = contextValue ;
    }
    
    public static Boolean isOptionAvailable(int res){
        
        if(hideScreensInApp.contains(context.getString(res).toUpperCase().replaceAll(" ", "").replaceAll("\\&", ""))){
            return false ;
        }else{
            return true;
        }
