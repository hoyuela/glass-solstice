...
public class ExtendingScrollView extends ScrollView {
    ...
    public ExtendingScrollView(final Context context, final AttributeSet as) {
        super(context, as);
    ...
    @Override
    protected void onOverScrolled(final int scrollX, final int scrollY,
     ...
     * @param a
     */
    public void attachFragment(final BaseFragment a) {
        this.a = a;
    }
