 ...
 * <com.discover.mobile.common.help.HelpWidget android:id="@+id/help"
...
public class HelpWidget extends RelativeLayout {
    ...
    public HelpWidget(final Context context, final AttributeSet attrs) {
        ...
        adapter = new HelpAdapter(context, R.layout.help_list_item,
                new ArrayList<HelpItemGenerator>());
        ...
        help.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                if (expandableView.getVisibility() == View.INVISIBLE) {
                    ...
                    help.setImageDrawable(context.getResources().getDrawable(
                            R.drawable.help_icon_gray_no_glow));
                } else {
    ...
    /**
     * Show the help items in the menu so that they can be clicked on. This will
     * show all the items in the list in the order that the items are in the
     * list.
     * 
     * @param items
