 ...
 * 
 */
public class CardAccountToggleView extends RelativeLayout {
    ...
    public CardAccountToggleView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        this.context = context;

        view = View.inflate(context, R.layout.account_toggle_card, this);
        indicator = (ImageView) view.findViewById(R.id.acct_toggle_indicator);
        bubble = (RelativeLayout) view.findViewById(R.id.acct_toggle_bubble);
        ...
        cardCheck = (ImageView) view.findViewById(R.id.acct_toggle_card_check);
        bankCheck = (ImageView) view.findViewById(R.id.acct_toggle_bank_check);
        cardEnding = (TextView) view
                .findViewById(R.id.acct_toggle_card_subtext);
        ...
        final CardInfoForToggle cardInfo = FacadeFactory.getCardFacade()
                .getCardInfoForToggle(this.context);

        if (null != cardInfo) {
            cardName.setText(cardInfo.getCardAccountName());
            cardEnding.setText(context.getResources().getString(
                    R.string.account_card_ending_in)
     ...
     */
    public void setCardNameAndEnding(final String name,
            final String endingDigits) {
     ...
     *            height of icon
     */
    public void setIndicatorPosition(final int left, final int top,
            final int iconWidth, final int iconHeight) {

        indicator.setPadding(left + iconWidth / 3, top + iconHeight / 3 + 5, 0,
                0);
