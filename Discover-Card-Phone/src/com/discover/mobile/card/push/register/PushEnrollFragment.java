...
/**
 * This is the fragment that allows the user to enroll in push alerts. This is
 * will be displayed when the user goes through profile and settings and then
 * clicks on enroll in reminders. If the user clicks enroll then the app will
 * register the acceptance of the notification with Discover's server. If the
 * user clicks cancel it will just go back to the last fragment displayed.
 * 
 * @author jthornton
 * 
 */
public class PushEnrollFragment extends BasePushRegistrationUI {
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        final TextView cancel = (TextView) view
                .findViewById(R.id.enroll_decline);
    ...
    public int getSectionMenuLocation() {
        return CardMenuItemLocationIndex.CREATE_CASH_PIN_SECTION;
    }
}
