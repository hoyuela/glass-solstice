...
public class PushRegisterErrorHandler extends CardBaseErrorResponseHandler {
     ...
     */
    public PushRegisterErrorHandler(final ErrorHandlerUi errorHandlerUi,
            final PushRegistrationUI fragment, final boolean isOptedIn) {
    ...
    protected boolean handleJsonErrorCode(
            JsonMessageErrorResponse messageErrorResponse) {
        if (isOptedIn)
