...
public class XtifyEventReceiver extends BroadcastReceiver
{
	...
	public void onReceive(Context context, Intent intent)
	{
		...
		{
			if(!(pushSharedPrefs.getBoolean(PushConstant.pref.PUSH_OTHER_USER_STATUS, false) && 
					(Globals.getCurrentAccount() != null) && (Globals.getCurrentAccount() == AccountType.CARD_ACCOUNT)) 
					|| !((Globals.getCurrentAccount() != null) && (Globals.getCurrentAccount() == AccountType.BANK_ACCOUNT)))
			{
