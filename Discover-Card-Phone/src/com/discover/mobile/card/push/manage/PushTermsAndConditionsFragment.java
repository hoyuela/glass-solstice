...
/**
 * The push terms and conditions screen. It shows the terms and conditions to
 * the user for the push notifications.
 * 
 * @author jthornton
 * 
 */
public class PushTermsAndConditionsFragment extends BaseFragment {
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        final View view = inflater.inflate(R.layout.push_terms_and_conditions,
                null);
        return view;
    }
