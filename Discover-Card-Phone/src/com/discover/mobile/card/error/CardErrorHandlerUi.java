...
public interface CardErrorHandlerUi {
    ...
    /**
     * returns the error label which the error handler will use to display error
     * text
     * 
     * @return
     */
    ...
    /**
     * Show a one button dialog that accepts dynamic string of body text (not
     * resource text)
     * 
     * To be used if we ever want to directly display an error message from a
     * third party, instead of using a canned resource
     * 
     * 
     * @param title
     * @param content
     ...
     * 
     * for fragment, this is the activityfragment. for activities, this is
     * itself
     * 
     * @return
     */
