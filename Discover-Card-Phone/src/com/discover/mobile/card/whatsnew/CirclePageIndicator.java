...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public boolean onTouchEvent(final android.view.MotionEvent ev) {
        ...
        case MotionEvent.ACTION_MOVE: {
            ...
            if (mIsDragging) {
                 ...
                 * mViewPager.beginFakeDrag()) { mViewPager.fakeDragBy(deltaX);
                 * }
                 */
            }
    ...
    public void setOnPageChangeListener(
            final ViewPager.OnPageChangeListener listener) {
        mListener = listener;
    }
    ...
    private int measureLong(final int measureSpec) {
        ...
        if (specMode == MeasureSpec.EXACTLY || mViewPager == null) {
            ...
            final int count = mViewPager.getAdapter().getCount();
            result = (int) (getPaddingLeft() + getPaddingRight() + count * 2
                    * mRadius + (count - 1) * mRadius + 1);
