...
/**
 * Late payment warning modal detail object. This will hold information that
 * will eventually be placed into a string.
 * 
 * @author jthornton
 * 
 */
public class LatePaymentWarningDetail implements Serializable {
    ...
    /**
     * String holding the penalty APR code. Used to match to the late payment
     * warning text detail
     */
