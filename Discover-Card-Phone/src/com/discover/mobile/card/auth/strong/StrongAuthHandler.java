...
public class StrongAuthHandler {
     ...
     * @param authListener
     */
    public StrongAuthHandler(Context context, StrongAuthListener authListener) {
     ...
     * @param requestCode
     */
    public StrongAuthHandler(Context context, CardEventListener listener,
            int requestCode) {
        this.context = context;
    ...
    public void strongAuth() {
        ...
        strongAuthQuestionListener = new CardEventListener() {
            ...
            public void onSuccess(Object data) {
                ...
                Intent strongAuth = new Intent(context,
