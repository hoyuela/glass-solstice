...
public class StrongAuthEnterInfoActivity extends Activity implements
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		/* 13.4 site cat tagging */
		/* 13.5 Changes */
		forgotUserIdFlow = getIntent().getBooleanExtra("ForgotUserIdFlow",
				false);
		forgotDetails = getIntent().getStringArrayExtra("ForgotDetails");
		/* 13.5 Changes */
					...
					StrongAuthEnterInfoActivity.this, new CardEventListener() {
						...
						public void onSuccess(final Object data) {
							if (!forgotUserIdFlow) {
								...
								try {
									forgotUserId.sendRequest(forgotDetails);
	...
	public class SuccessModalConfirmationTop extends RelativeLayout implements
		...
		public SuccessModalConfirmationTop(final Context context,
			...
			securityMessage = (TextView) mainView
					.findViewById(R.id.account_info_confirm_security_precaution_label);
			forgotRelatedDetails = (RelativeLayout) mainView
					.findViewById(R.id.account_info_layout);
			done = (Button) mainView.findViewById(R.id.sa_done);

			if (forgotUserIdFlow) {
				
				securityMessage.setVisibility(View.VISIBLE);
				forgotRelatedDetails.setVisibility(View.VISIBLE);
				
				successMessage = (TextView) mainView
						.findViewById(R.id.sa_message);
				userIdLabel = (TextView) mainView
						.findViewById(R.id.account_info_confirm_id_label);
				userEmailLabel = (TextView) mainView
						.findViewById(R.id.account_info_confirm_email_label);
				userAcctNbrLabel = (TextView) mainView
						.findViewById(R.id.account_info_confirm_account_label);
				
				successMessage.setText(R.string.sa_confirm_text_forgot_user);
				done.setText(R.string.home_text);
				if(registrationConfirmationDetails!=null){
				userIdLabel.setText(registrationConfirmationDetails.userId);
				userEmailLabel.setText(registrationConfirmationDetails.email);
				userAcctNbrLabel.setText(registrationConfirmationDetails.acctLast4);
				}
				
			}else{
				securityMessage.setVisibility(View.GONE);
				forgotRelatedDetails.setVisibility(View.GONE);
			}
			/* 13.5 Changes */
	...
	public void successModal(
		...
		top.getButton().setOnClickListener(new OnClickListener() {
			...
			public void onClick(final View v) {
				...
				Utils.updateAccountDetails(StrongAuthEnterInfoActivity.this,
						cardEventListener, "Discover", "Loading...");
				modal.dismiss();
			}
		});
		modal.show();
