...
public final class CardMenuItemLocationIndex {
    ...
    /* 13.3 Changes */
    public static CardMenuItemLocationIndex getInstance(final Context context) {
    ...
    private static void initialiseMap() {
         ...
         * R.string.sub_section_title_manage_bank_information, new Pair<Integer,
         * Integer>(PAYMENT_GROUP, MANAGE_BANK_INFO_SECTION));
         */
        itemIdLocationMap.put(R.string.sub_section_title_manage_bank_accounts,
                new Pair<Integer, Integer>(PAYMENT_GROUP,
