...
/**
 * Late payment modal top view. This contains a title as well as some content
 * text to be displayed under the text view.
 * 
 * @author jthornton
 * 
 */
public class LatePaymentModalTop extends ScrollView implements ModalTopView {
    ...
    public LatePaymentModalTop(final Context context, final AttributeSet attrs) {
        ...
        final View mainView = (View) LayoutInflater.from(context).inflate(
                R.layout.modal_late_payment_warning_top, null);

        res = context.getResources();

        dueDateLabel = (TextView) mainView
                .findViewById(R.id.payment_date_label);
     ...
     * 
     * @param resource
     *            - string representing the resource to be displayed
     */
