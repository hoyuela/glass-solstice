 ...
 * retrieval of the user specific details. The text is retrieved in another
 * call.
 * 
 * @author jthornton
 * 
 */
public class LatePaymentWarningSuccessListener implements
        SuccessListener<LatePaymentWarningDetail> {
     ...
     */
    public LatePaymentWarningSuccessListener(
    ...
    public void success(final NetworkServiceCall<?> sender,
            final LatePaymentWarningDetail detail) {
