...
/**
 * Fragment that allows the user to select a list of dates that can be selected
 * as sort criteria for the account activity fragment.
 * 
 * @author jthornton
 * 
 */
public class ChooseDateRangeFragment extends BaseFragment {
     ...
     * 
     * @param fragment
     *            - the fragment that needs to have the selected period returned
     *            to it
     */
     ...
     *            - period to be selected in the return fragment
     */
    ...
    public void displayDateRanges() {
        for (final RecentActivityPeriodDetail detail : periods.dates) {
            final ChoosePeriodItem item = new ChoosePeriodItem(context, null,
                    detail);
     ...
     * 
     * @param periods
     *            - the periods to be shown in the list
     */
