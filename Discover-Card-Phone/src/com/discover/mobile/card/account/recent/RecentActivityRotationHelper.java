...
/**
 * Singleton class that helps with the rotations of the recent activity screen.
 * This is used because that screen can have massive amounts of data to store
 * and the processing time to store all of that data in the bundle could become
 * a cumbersome.
 * 
 * **** Note: Make sure that this is clear once the rotation is complete, there
 * is no need to keep this object around. ****
 * 
 * @author jthornton
 * 
 */
