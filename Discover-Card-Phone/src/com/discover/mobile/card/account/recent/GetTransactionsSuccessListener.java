...
public class GetTransactionsSuccessListener implements
        SuccessListener<GetTransactionDetails> {
     ...
     */
    public GetTransactionsSuccessListener(
    ...
    public void success(final NetworkServiceCall<?> sender,
            final GetTransactionDetails successObject) {
