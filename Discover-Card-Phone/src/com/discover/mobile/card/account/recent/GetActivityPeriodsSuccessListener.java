...
/**
 * Success listener for getting the periods that can be selected to view
 * transactions for.
 * 
 * @author jthornton
 * 
 */
public class GetActivityPeriodsSuccessListener implements
        SuccessListener<RecentActivityPeriodsDetail> {

    /** Local instance of the fragment making this call */
    private final AccountRecentActivityFragment fragment;

    /**
     * Constructor for the class, letting the listener know the fragment using
     * it
     * 
     * @param fragment
     *            - fragment using this listener
     * @param isOptedIn
     *            - true is the user is opting into push alerts
     */
    public GetActivityPeriodsSuccessListener(
    ...
    /**
     * Handle when the call is successful, in this case send it to the next
     * screen
     */
    @Override
    public void success(final NetworkServiceCall<?> sender,
            final RecentActivityPeriodsDetail detail) {
