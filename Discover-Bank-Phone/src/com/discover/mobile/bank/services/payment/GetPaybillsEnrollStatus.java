 ...
 * eligibility of a customer for manage payees and paybills services. This class is based off of
 * GetEnrolledStatusServiceCall call whose parseSuccessResponse is called when receiving a successful response.
 * 
 * Request: Payments API: GET https://asys.discoverbank.com/api/payments/enrollment
 * 
 * Response: { "enrolled": true, "links": { *"enrollment": { *"allowed": [ *"GET", "POST" ], "ref":
 * "Payments.Enrollment" }, "terms": { "allowed": [ "GET" ], "ref": "Payments.Terms" } } }
 * 
 * @author henryoyuela
 * 
 */
public final class GetPaybillsEnrollStatus extends GetEnrolledStatusServiceCall {
	 ...
	 */
	public GetPaybillsEnrollStatus(final Context context, final AsyncCallback<Eligibility> callback) {
