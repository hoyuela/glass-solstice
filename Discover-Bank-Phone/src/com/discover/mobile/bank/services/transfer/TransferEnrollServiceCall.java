 ...
 * eligibility of a customer for transfer services. This class is based off of EnrollmentService call
 * whose parseSuccessResponse is called when receiving a successful response.
 * 
 * Request:
 * Payments API: GET https://asys.discoverbank.com/api/transfers/enrollment
 *
 * Response:
 *	{
 *	    "enrolled": true,
 ...
 * 
 */
public final class TransferEnrollServiceCall extends EnrollmentServiceCall {
	/**
	 * 
	 * @param context
	 ...
	 */
	public TransferEnrollServiceCall(final Context context, final AsyncCallback<Eligibility> callback) {
