 ...
 * eligibility of a customer for deposit services. This class is based off of GetEnrolledStatusServiceCall call whose
 * parseSuccessResponse is called when receiving a successful response.
 * 
 * Request: Payments API: GET https://asys.discoverbank.com/api/deposits/enrollment
 * 
 ...
 * 
 */
public final class GetDepositEnrollStatus extends GetEnrolledStatusServiceCall {
	/**
	 * 
	 * @param context
	 ...
	 */
	public GetDepositEnrollStatus(final Context context, final AsyncCallback<Eligibility> callback) {
