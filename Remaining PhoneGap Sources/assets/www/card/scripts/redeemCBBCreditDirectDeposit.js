...
function statementCredit1Load(){
	try{		
		var validPriorPagesOfStat1= new Array("redemptionLanding","statementCredit2");
...
dfs.crd.cbb.populateStatementCredit3PageDiv = function(cacheRedeemCBBDetails){
	try{
		if(!jQuery.isEmptyObject(cacheRedeemCBBDetails)){
			...
			$("#statementCredit3_DiscoverCardEnding").html(globalLastFourAcctNbr);
		}
...
function directDeposit1Load() {
	try{		
		var validPriorPagesOfDirect1= new Array("redemptionLanding","directDeposit2","customerServiceUpdateAccount");
