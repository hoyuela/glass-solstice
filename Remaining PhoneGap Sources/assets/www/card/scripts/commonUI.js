...
$('body').live('pagebeforeshow',function(event){
	try {
	 $('input[type="text"], textarea').attr('spellcheck','false');
        ...
        var headerHTML="<div class='leftPart' id='back-btn'><a data-rel='back'><div class='back_btn_normal'></div></a><a href='#' onclick = 'navigation(\"../pushNotification/alertHistory\");' id='alert_history_page_link' class='ui-link'><div class='notification_image_header'><div class='number-of-new-messages'></div></div></a></div><div class='centerPart'><a href='#' class='head-bg-logo'></a></div><div class='logout-button boldtext rightPart'><a href='#' class='ui-link' onclick='dfs.crd.lilo.logOutUser(\"LOGOUT\")'>Log Out</a></div> <div class='clearboth'></div>" ;
        ...
        var headerHTML_nobackbtn= "<div class='leftPart'><a href='#' onclick = 'navigation(\"../pushNotification/alertHistory\");' id='alert_history_page_link' class='ui-link'><div class='notification_image_header'><div class='number-of-new-messages'></div></div></a></div><div class='centerPart'><a href='#' class='head-bg-logo'></a></div><div class='logout-button boldtext rightPart'><a href='#' class='ui-link' onclick='dfs.crd.lilo.logOutUser(\"LOGOUT\")'>Log Out</a></div> <div class='clearboth'></div>" ;
        ...
        var headerHTML_nologout="<div class='leftPart' id='back-btn'><a data-rel='back'><div class='back_btn_normal'></div></a></div><div class='centerPart'><a href='#' class='head-bg-logo'></a></div><div class='clearboth'></div>" ;
        ...
        var headerHTML = "<div class='leftPart'><a href='#' onclick = 'navigation(\"../pushNotification/alertHistory\");' id='alert_history_page_link' class='ui-link'><div class='notification_image_header'><div class='number-of-new-messages'></div></div></a></div><div class='centerPart'><a href='#' class='head-bg-logo'></a></div><div class='logout-button boldtext rightPart'><a href='#' class='ui-link' onclick='dfs.crd.lilo.logOutUser(\"LOGOUT\")'>Log Out</a></div> <div class='clearboth'></div>";
