		...
		if (!jQuery.isEmptyObject(responseData)) {
			...
			if (dfs.crd.p2p.maxTransactionCount >= 0) {
				...
				for (loopCount in entityList) {
					...
					var divForStatus = "";
					var statushtml = "";
					var detailshtml = "<li class='noborder' style='padding-bottom:0px !important;'><a href='#' class='bluelink boldtext collapsdata' id='aId"
							+ loopCount
							+ "' rel='data_trns_his"
							+ loopCount
							...
							+ transactionDate
							+ "</span></div><div>Status<span class='boldtext'>"
							+ status + "</span></div></li>";
					if (status == "PENDING") {
						...
						statushtml = "<li class='trans_history noborder'><div class='floatleft'>Status</div><div class='floatright'>"
								+ divForStatus
					...
					var UL = "<ul class='whitebg-list-view collapsible' id='historyId' ><li> Transaction Date<span class='boldtext fontsize13px' id='spanTransDate"
							+ loopCount
							+ "'>"
							+ transactionDate
							+ "</span></li><li>Amount<span class='boldtext' id='spanAmt"
							+ loopCount
							+ "'>$"
							+ amount
							+ "</span> </li><li>Transaction ID<span class='boldtext' id='spanTransId"
							+ loopCount
							+ "'>"
							+ transactionId
							+ "</span></li><li>Recepient's Name<span class='boldtext' id='spanRecpNme"
							+ loopCount
							+ "'>"
							+ recepientname
							+ "</span></li>"
