...
dfs.crd.reg.flow = {
	forgotUserId : {
		load : function() {
			if (dfs.crd.reg.nav.handleNav(this)) { return; }
    	...
    	backNavToHome : ['forgotUserIdConfirmation', 'alertHistory', 'accountLanding', 'cardHome']
	},    
    forgotUserIdConfirmation : {
    	...
    	backNavToHome : ['alertHistory', 'accountLanding', 'cardHome']
    },    
	forgotPasswordStep1 : {
		load : function() {
			if (dfs.crd.reg.nav.handleNav(this)) { return; }
    ...
    forgotPasswordStep2 : {     
		...
		backNavToHome : ['forgotPasswordConfirmation', 'alertHistory', 'accountLanding', 'cardHome']
    }, 
    ...
    forgotBothStep2 : {     
		...
		backNavToHome : ['forgotBothConfirmation', 'alertHistory', 'accountLanding', 'cardHome']
    }, 
...
dfs.crd.reg.ui = {
	prepareFooter : function() {
		...
		//var myFootnotesHtml="<p id='footer-links'><a href='#'  onclick='cbInvoke();'>Provide Feedback </a><a href='#' onclick='dfs.crd.reg.nav.goToRegistration();'  data-rel='external' class='registerNow'>| Register Now</a></p><p data-theme='e' class='footer-text-icon'><span>&copy;2013 Discover Bank, Member FDIC.</span></p>";
		var myFootnotesHtml="<a href='#' onclick='cbInvoke();' id='footer-links'>Provide Feedback</a><span class='divspace' style='font-size:15px'>|</span><p id='footer-text'>&copy;2013 Discover Bank, Member FDIC <span id='wordSecured'>| SECURED</span></p>";
		$(".reg-footnotes").html(pubFootnotes + myFootnotesHtml);*/
		var footnotesHtml="<div class='need-help'><span>Need Help?</span> <a href='tel:18003472683'>Call 1-800-347-2683</a></div><p id='footer-links'><a href='#'  onclick='provideFeedBack();'>Provide Feedback </a><a href='#' onclick='dfs.crd.reg.nav.goToRegistration();'  data-rel='external' class='registerNow'>| Register Now</a></p><!--p data-theme='e' class='footer-text-icon'><span>&copy; 2013 Discover Bank, Member FDIC<span class='secured'> | SECURED</span></p-->";
...
dfs.crd.reg.getSSOForgotUserIdErrorText = function(errorCode) {
	var serverErrorText = dfs.crd.reg.shared.util.getErrorText();

	if (!isEmpty(serverErrorText) && !isEmpty(serverErrorText[errorCode + "_handset"])) {
		//use server, device specific
		error = serverErrorText[errorCode + "_handset"];	
	} else {
		//use local
		error = dfs.crd.reg.shared.constant.error[errorCode + "_handset"];
	}
...
function forgotUserIdOrPasswordMenuLoad() {
	try {
		...
		forgotUserIdOrPasswordMenuSCVariables();//passing sitecatalyst variable for Forgot User ID/Password Screen
	} catch (err) {
		showSysException(err);
	}
}
...
function forgotUserIdLoad() {
	try {
		...
		forgotUserIdSCVariables();//passing sitecatalyst variable for Forgot User ID Screen
	} catch (err) {
		showSysException(err);
	}
}
...
function forgotUserIdConfirmationLoad() {
	try {
		...
		forgotUserIdConfirmationSCVariables();//passing sitecatalyst variable for Submit Forgot User ID Page
	} catch (err) {
		showSysException(err);
	}
}
...
function forgotBothStep1Load() {
	try {
		...
		forgotBothStep1SCVariables();//passing sitecatalyst variable for Forgot Both User ID and Password: Step 1
	} catch (err) {
		showSysException(err);
	}
}
...
function forgotBothStep2Load() {
	try {
		...
		forgotBothStep2SCVariables();//passing sitecatalyst variable for Forgot Both User ID and Password: Step 2
	} catch (err) {
		showSysException(err);
	}
}
...
function forgotBothConfirmationLoad() {
	try {
		...
		forgotBothConfirmationSCVariables();//passing sitecatalyst variable for Forgot Both User ID and Password: Step 2 : Submit
	} catch (err) {
		showSysException(err);
	}
}
...
function forgotPasswordStep1Load() {
	try {
		...
		forgotPasswordStep1SCVariables();//passing sitecatalyst variable for Forgot Password Screen: Step 1
	} catch (err) {
		showSysException(err);
	}
}
...
function forgotPasswordStep2Load() {
	try {
		...
		forgotPasswordStep2SCVariables();//passing sitecatalyst variable for Forgot Password Screen: Step 2
	} catch (err) {
		showSysException(err);
	}
}
...
function forgotPasswordConfirmationLoad() {
	try {
		...
		forgotPasswordConfirmationSCVariables();//passing sitecatalyst variable for Forgot Password Screen: Step 2 :  Submit
	} catch (err) {
		showSysException(err);
	}
}
