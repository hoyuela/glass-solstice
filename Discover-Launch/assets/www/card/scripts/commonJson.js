var menuItems = {
	...
	PS_MORE:"<li data-icon='false' class='ui-btn ui-btn-icon-right ui-li ui-btn-up-d'><div class='ui-btn-inner ui-li' aria-hidden='true'><div class='ui-btn-text'><a href='#' onclick='navigation(\"privacyPolicyMore\");' class='amt_bold ui-link-inherit'>Mobile Privacy Statement</a><span class='floatright payArr'> </span></div></div></li>",
	TU_MORE:"<li data-icon='false' class='ui-btn ui-btn-icon-right ui-li ui-btn-up-d ui-corner-bottom'><div class='ui-btn-inner ui-li' aria-hidden='true'><div class='ui-btn-text'><a href='#' onclick='navigation(\"termsUseMore\");' class='amt_bold ui-link-inherit'>Mobile Terms of Use</a><span class='floatright payArr'> </span></div></div></li>"/*13.3 Global Change:Ends*/
}
