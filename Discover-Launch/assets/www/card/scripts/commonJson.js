var menuItems = {
	...
	MM_MORE:"<li data-icon='false'class='ui-btn ui-btn-icon-right ui-li ui-corner-top ui-btn-up-d'><div class='ui-btn-inner ui-li' aria-hidden='true'><div class='ui-btn-text'><a href='#' onclick='showMM();' class='bluelink ui-link-inherit'>Send Money</a><spanclass='floatright arrow'> </span></div></div></li>",
