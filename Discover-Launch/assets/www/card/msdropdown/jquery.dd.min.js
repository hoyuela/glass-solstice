...
function dd(element, settings) {
	...
	var _open = function (e) {
		...
		if (!_isOpen) {
			...
			/*13.3 Global Change - 2-Aug-2013 - Performance Change for drop down - Start*/			
				// $("#" + childid)[animStyle]("fast", function () {
				   $("#" + childid)[animStyle](10, function () {
			/*13.3 Global Change - 2-Aug-2013 - Performance Change for drop down - end*/
					_scrollToIfNeeded();
					if (typeof _settings.on.open == "function") {
						var d = _getDataAndUI();
						_settings.on.open(d.data, d.ui);
