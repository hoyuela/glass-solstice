...
import com.discover.mobile.bank.paybills.schedule.SchedulePaymentLandingPage;
...
public final class BankPayBillsSectionInfo extends GroupComponentInfo {
	...
	public BankPayBillsSectionInfo() {
		super(R.string.section_title_pay_bills,
				new FragmentComponentInfo(R.string.section_title_pay_bills, SchedulePaymentLandingPage.class),
