...
public abstract class BasePushManageToggleItem extends RelativeLayout implements PushManageCategoryItem{
	 ...
	 * @param isChecked - if the toggle box should be set
	 */
	 ...
	 * @param toggleImage - image to be toggled
	 * @param isChecked - if the item should be checked
	 */
	 ...
	 * @param isEnabled - if the the text enable box active or not active
	 */
	 ...
	 * @param textToggle - the text toggle view
	 */
	 ...
	 * @param pushToggle - the push toggle view
	 */
	 ...
	 * @param headerView -  the header view of the item
	 */
	...
	/**
	 * Get if the text preference was already set active by what was received from the server
	 * @return if the text preference was already set active by what was received from the server
	 */
	...
	public void setWasTextAlreadySet(final boolean isAlreadySet) {
		this.wasTextAlreadySet = isAlreadySet;
	}

	/**
	 * Set the fragment using these items
	 * @param fragment - the fragment using these items
	 */
