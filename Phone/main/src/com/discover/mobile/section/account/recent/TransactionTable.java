...
public class TransactionTable extends RelativeLayout{
	 ...
	 * @param transactions - transactions to show in the linear layout
	 */
	public void showTransactions(final List<TransactionDetail> transactions){
		if(null == transactions || transactions.isEmpty()){
			...
			for(TransactionDetail transaction : transactions){
				...
				item.setBackgroundResource((isWhiteBackground) ? R.color.white : R.color.transaction_table_stripe);
	 ...
	 * @param title - string that should be shown in the title
	 */
	 ...
	 * @param transactions - the transactions being displayed in the linear layout
	 */
	 ...
	 * @param message - message that should be shown if there are no transactions
	 */
