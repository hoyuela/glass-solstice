...
import com.discover.mobile.common.R.attr;
import com.discover.mobile.common.R.styleable;
 ...
 */
public class DiscoverToggleSwitch extends CompoundButton {
     ...
     */
    public DiscoverToggleSwitch(Context context, AttributeSet attrs) {
     ...
     */
    public DiscoverToggleSwitch(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.DiscoverToggleSwitch, defStyle, 0);

        mThumbDrawable = a.getDrawable(R.styleable.DiscoverToggleSwitch_thumb);
        mTrackDrawable = a.getDrawable(R.styleable.DiscoverToggleSwitch_track);
        mTextOn = a.getText(R.styleable.DiscoverToggleSwitch_textOn);
        mTextOff = a.getText(R.styleable.DiscoverToggleSwitch_textOff);
        mThumbTextPadding = a.getDimensionPixelSize(
        		R.styleable.DiscoverToggleSwitch_thumbTextPadding, 0);
        mSwitchMinWidth = a.getDimensionPixelSize(
        		R.styleable.DiscoverToggleSwitch_switchMinWidth, 0);
        mSwitchPadding = a.getDimensionPixelSize(
        		R.styleable.DiscoverToggleSwitch_switchPadding, 0);

        int appearance = a.getResourceId(
        		R.styleable.DiscoverToggleSwitch_switchTextAppearance, 0);
        if (appearance != 0) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (measuredHeight < switchHeight) {
        	//the following line was switched from getMeasuredWidthAndState()
        	//to getMeasuredWidth() for compatibility reasons
    ...
    /*created this method to always return false
     * since all of use cases require text to be on left side.
     */
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(DiscoverToggleSwitch.class.getName());
    }
}
